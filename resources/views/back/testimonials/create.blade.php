                                ...
                                <div class='row'>
									...
									<div class='col-md-6 col-12'>
										<div class='form-group'>
											...
											<input type='text' id='first-date-column' class='form-control' name='date'>
										</div>
									</div>
									<div class='col-md-6 col-12'>
										<div class='form-group'>
											<label for='first-categorie-column'>categorie</label>
											<input type='text' id='first-categorie-column' class='form-control' name='categorie'>
										</div>
									</div>
                                    <div class='col-md-6 col-12'>
                                        <div class='form-group'>
                                            <label for='first-rating-column'>rating</label>
                                            <input type='text' id='first-rating-column' class='form-control' name='rating'>
                                        </div>
                                    </div>
                                    <div class='col-md-6 col-12'>
                                        <div class='form-group'>
                                            <label for='first-commentaire-column'>commentaire</label>
                                            <input type='text' id='first-commentaire-column' class='form-control' name='commentaire'>
                                        </div>
                                    </div>
                                    <div class='col-md-6 col-12'>
                                        <div class='form-group'>
                                            <label for='first-taff-column'>taff</label>
                                            <input type='text' id='first-taff-column' class='form-control' name='taff'>
                                        </div>
                                    </div>
                                    <div class='col-md-6 col-12'>
                                        <div class='form-group'>
